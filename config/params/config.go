...
type BeaconChainConfig struct {
	...
	DomainAotBlob                     [4]byte `yaml:"DOMAIN_AOT_BLOB" spec:"true"`                       // DomainAotBlob defines the BLS signature domain for ahead-of-time (AOT) blob info signatures (Blob Streaming).
