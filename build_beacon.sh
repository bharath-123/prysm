...
SCRIPT_DIR=/Users/vedabharath/ef-work/prysm
...
docker build -t "test-multi-client-builder-api"  --build-arg ENTRY=/app/cmd/beacon-chain/beacon-chain -f "./../Dockerfile.beacon" .
