...
def prysm_deps():
    ...
    go_repository(
        ...
        sum = "h1:ag6geu0kn8Hv5FLKTpH+Hm2DHD+iuFtuqKxEuwUsDOI=",
        version = "v1.17.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Ag83At00qa4FLkcdMgrwHVSakqky/eZczOlxd4q336E=",
    ...
    go_repository(
        ...
        sum = "h1:bTDadT+3fK497EvLdWRQEjiGnUtzJ7jjIUMF0jqwYhE=",
        version = "v0.3.16",
    )
    go_repository(
