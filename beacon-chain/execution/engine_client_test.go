...
func TestClient_IPC(t *testing.T) {
	...
	t.Run(NewPayloadMethod, func(t *testing.T) {
		...
		require.NoError(t, err)
		latestValidHash, err := srv.NewPayload(ctx, wrappedPayload, []common.Hash{}, nil, &common.Hash{}, nil)
		require.NoError(t, err)
...
func TestClient_HTTP(t *testing.T) {
	...
	t.Run(NewPayloadMethod+" VALID status", func(t *testing.T) {
		...
		require.NoError(t, err)
		resp, err := client.NewPayload(ctx, wrappedPayload, []common.Hash{}, nil, &common.Hash{}, nil)
		require.NoError(t, err)
	...
	t.Run(NewPayloadMethodV3+" VALID status", func(t *testing.T) {
		...
		require.NoError(t, err)
		resp, err := client.NewPayload(ctx, wrappedPayload, []common.Hash{}, nil, &common.Hash{'a'}, nil)
		require.NoError(t, err)
		require.DeepEqual(t, want.LatestValidHash, resp)
	})
	t.Run(NewPayloadMethodV4+" VALID status", func(t *testing.T) {
		...
		resp, err := client.NewPayload(ctx, wrappedPayload, []common.Hash{}, nil, &common.Hash{'a'}, requests)
		require.NoError(t, err)
		require.DeepEqual(t, want.LatestValidHash, resp)
	})
